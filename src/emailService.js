    ...
    html: `
      <div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:32px 24px;border:1px solid #e5e7eb;border-radius:8px;">
        ...
        <p style="margin:0 0 24px;color:#6b7280;font-size:14px;">
          ...
          It expires in <strong>${expiryMinutes} minute${expiryMinutes !== 1 ? "s" : ""}</strong>.
        </p>
        <div style="letter-spacing:0.3em;font-size:36px;font-weight:700;color:#111827;text-align:center;padding:20px 0;background:#f9fafb;border-radius:6px;">
          ${otp}
        </div>
